...
class Player():
    ...
    def strategy(self, allcells):
        ...
        while j:
            ...
            elif survive()>50 and mindistance_cell.radius <0.9* allcells[self.id].radius and mindistance_cell.radius >0.2* allcells[self.id].radius or mindistance_cell.radius>4:
